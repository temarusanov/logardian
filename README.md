...
We made logger base on [LoggerService](https://github.com/nestjs/nest/blob/master/packages/common/services/logger.service.ts) but does not use it, so as not to include the NestJS libraries. But you can also use the Logardian instead of common NestJS logger.
